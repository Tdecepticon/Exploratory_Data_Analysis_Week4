...
Course project 2
Every .R file begins with loading& reading data string, but from plot2.R these strings were mostly commented, because files were already downloaded. 

NEI & SCC variables were read by the following commands from the task description page
